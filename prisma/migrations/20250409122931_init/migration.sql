...
CREATE TABLE `Accountant` (
    ...
    `role` ENUM('USER', 'AGENT', 'ADMIN', 'SUPER', 'CLIENT', 'ACCOUNTANT', 'CALLCENTER', 'BANKUSER', 'BOTUSER') NOT NULL DEFAULT 'ACCOUNTANT',
...
CREATE TABLE `BankUser` (
    ...
    `login` VARCHAR(191) NULL,
    `password` VARCHAR(191) NULL,
    `role` ENUM('USER', 'AGENT', 'ADMIN', 'SUPER', 'CLIENT', 'ACCOUNTANT', 'CALLCENTER', 'BANKUSER', 'BOTUSER') NOT NULL DEFAULT 'BANKUSER',
    `work_status` ENUM('WORKING', 'BLOCKED', 'DELETED') NOT NULL DEFAULT 'WORKING',
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NULL,
...
CREATE TABLE `CallCenter` (
    ...
    `login` VARCHAR(191) NULL,
    `password` VARCHAR(191) NULL,
    `role` ENUM('USER', 'AGENT', 'ADMIN', 'SUPER', 'CLIENT', 'ACCOUNTANT', 'CALLCENTER', 'BANKUSER', 'BOTUSER') NOT NULL DEFAULT 'CALLCENTER',
    `work_status` ENUM('WORKING', 'BLOCKED', 'DELETED') NOT NULL DEFAULT 'WORKING',
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NULL,
...
CREATE TABLE `Super` (
    ...
    `login` VARCHAR(191) NULL,
    `password` VARCHAR(191) NULL,
    `role` ENUM('USER', 'AGENT', 'ADMIN', 'SUPER', 'CLIENT', 'ACCOUNTANT', 'CALLCENTER', 'BANKUSER', 'BOTUSER') NOT NULL DEFAULT 'SUPER',
    `work_status` ENUM('WORKING', 'BLOCKED', 'DELETED') NOT NULL DEFAULT 'WORKING',
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NULL,
...
CREATE TABLE `User` (
    ...
    `login` VARCHAR(191) NULL,
    `password` VARCHAR(191) NULL,
    `role` ENUM('USER', 'AGENT', 'ADMIN', 'SUPER', 'CLIENT', 'ACCOUNTANT', 'CALLCENTER', 'BANKUSER', 'BOTUSER') NOT NULL DEFAULT 'USER',
    `work_status` ENUM('WORKING', 'BLOCKED', 'DELETED') NOT NULL DEFAULT 'WORKING',
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NULL,
